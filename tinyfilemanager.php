...
$default_timezone = 'Europe/Paris'; // UTC+5:30

// Root path for file manager
//$root_path = 'C:\wamp64\www\100Come\Dossier_de_test\Tutoriels';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root

//$root_url = 'C:\wamp64\www\100Come\Dossier_de_test\Tutoriels';

//$root_url = 'file://EB-OR6147732/C$/wamp64/www/100Come';
...
//$_SESSION['aPath'] = $_POST['aPath'];

//var_dump($_SESSION['aPath']);

$root_path = $_SESSION['aPath'];
$root_url = $_SESSION['aPath'];

//$path = $_SESSION['aPath2'];
...
/*switch ($s) 
{
    case '1':
        ...
        break;
    case '2':
            $root_path = 'C:\wamp64\www\100Come\Dossier_de_test\Guides';
            $root_url = 'C:\wamp64\www\100Come\Dossier_de_test\Guides';
        break;
     case '3':
            $root_path = 'C:\wamp64\www\100Come\Dossier_de_test\Documents Techniques';
            $root_url = 'C:\wamp64\www\100Come\Dossier_de_test\Documents Techniques';
        break;
    case '4':
            $root_path = 'C:\wamp64\www\100Come\Dossier_de_test\Outils';
            $root_url = 'C:\wamp64\www\100Come\Dossier_de_test\Outils';
        break;
    case '5':
            $root_path = 'C:\wamp64\www\100Come\Dossier_de_test\Informations';
            $root_url = 'C:\wamp64\www\100Come\Dossier_de_test\Informations';
        break;
    case '6':
            $root_path = 'C:\wamp64\www\100Come\Dossier_de_test\Notes de versions';
            $root_url = 'C:\wamp64\www\100Come\Dossier_de_test\Notes de versions';
        break;
    default:
            $root_path = '';
            $root_url = '';
...
defined('FM_ROOT_URL') || define('FM_ROOT_URL', $root_url); //mdifier ici pour les URL
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
			<img src="img/logo.png" class="logo_popup" alt="Logo Orange">
        ...
        <!--<div class="path login-form">
            <button class="fancybox-item fancybox-close" onclick="javascript:;" title="Fermer"></button>
            <img src="img/logo.png" class="logo_popup" alt="Logo Orange">
            <span class="messagerie_form_popup_title heading-3">Votre messagerie accessible depuis Intranet</span>
            <div class="messagerie_menu_popup">
                <a href="https://exchange-eme2.itn.ftgroup/owa">Webmail Exchange</a><a href="http://webmail.sso.francetelecom.fr/">Webmail Orange Office</a>
            </div>
            <div class="messagerie_form_popup">
                <p class="messagerie_form_popup_text">Vous ne savez pas quel est votre système de messagerie ?<br>Tapez votre Identifiant Groupe (Cu-Id) ou votre adresse de messagerie et cette page va vous guider</p>
                <form name="loginform" action="/messagerie/messagerie.php" method="get" id="messagerie_form_exec">
                    <label class="messagerie_form_popup_label" for="userid"><span>C</span>&nbsp;<span class="cuid_special_Caracter">u</span>&nbsp;<span class="cuid_special_Caracter">i</span>&nbsp;<span class="cuid_special_Caracter">d</span> : </label><input class="messagerie_form_popup_input" id="userid" name="userid"><br><label class="messagerie_form_popup_label" for="emailid">Ou Mail : </label><input class="messagerie_form_popup_input" id="emailid" name="emailid" value="@orange.com" size="40" type="text"><br><input class="messagerie_form_popup_submit" value="Quel est mon système de messagerie ?" onclick="submit" name="Submit1" type="submit">
                </form>
                <p class="messagerie_response" id="messaging_response"></p>
            </div>
        </div>-->
...
<a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="float-right">File Manager</a></p>
-->
<?php endif; ?>
</form>
...
.login-form {width:550px;text-align:center;margin:0 auto;}
